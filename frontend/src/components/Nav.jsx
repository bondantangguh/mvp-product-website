  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-5 sm:px-8 h-16 sm:h-[72px]">
        <a href="#top" data-testid="nav-logo" className="font-display font-black text-xl tracking-tight text-white brand-split-sm">
          MVP
          <span className="hidden sm:inline font-body font-medium text-[10px] tracking-[0.2em] text-white/50 ml-3 align-middle">
